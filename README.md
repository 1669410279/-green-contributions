# -green-contributionsname: Fill History (Daily Auto + Manual Batch)
...
jobs:
  fill:
    ...
    steps:
      ...
      - name: Configure Git
        run: |
          git config --global user.email "1669410279@qq.com"      # 替换为你的 GitHub 验证邮箱
          git config --global user.name "1669410279"     # 替换为你的 GitHub 用户名
